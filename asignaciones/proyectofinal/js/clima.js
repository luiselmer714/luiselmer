...
let apiURLstring ='https://api.openweathermap.org/data/2.5/weather?id=3907584&units=imperial&APPID=a2278530004e75557bc8ffb56725d097';
...
weatherRequest.send ();
 ...
 document.getElementById("icon").setAttribute("src", "http://openweathermap.org/img/w/" + img01 + ".png");
